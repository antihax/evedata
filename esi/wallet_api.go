 ...
 */
func (a WalletApiService) GetCharactersCharacterIdWallets(ts TokenSource, characterId int32, datasource interface{}) ([]GetCharactersCharacterIdWallets200Ok,  time.Time, error) {
	var (
