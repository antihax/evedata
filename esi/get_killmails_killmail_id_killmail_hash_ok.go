...
type GetKillmailsKillmailIdKillmailHashOk struct {
	...
	// attackers array
	Attackers []GetKillmailsKillmailIdKillmailHashOkAttackers `json:"attackers,omitempty"`
	...
	Victim GetKillmailsKillmailIdKillmailHashOkVictim `json:"victim,omitempty"`
