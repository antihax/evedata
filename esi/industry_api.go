 ...
 */
func (a IndustryApiService) GetIndustryFacilities(datasource interface{}) ([]GetIndustryFacilities200Ok,  error) {
	var (
	...
	localVarPath := "https://esi.tech.ccp.is/latest/industry/facilities/"
 ...
 */
func (a IndustryApiService) GetIndustrySystems(datasource interface{}) ([]GetIndustrySystems200Ok,  error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := "https://esi.tech.ccp.is/latest/industry/systems/"
