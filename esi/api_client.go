 ...
 *
 * OpenAPI spec version: 0.3.10.dev6
 * 
...
// APIClient manages communication with the EVE Swagger Interface API v0.3.10.dev6
...
func NewAPIClient(httpClient *http.Client, userAgent string) *APIClient {
	...
	c := &APIClient{}
	c.client = httpClient
	c.basePath = "https://esi.tech.ccp.is/latest"
