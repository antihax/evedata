...
## New Client
```
  client, err := esiv1.NewClient(*http.Client, userAgent string)
```
...
```
  client, err := esiv1.NewClient(nil, "esiv1 client http://mysite.com")
...
```
  ...
  client, err := esiv1.NewClient(nil, "esiv1 client http://mysite.com")
  ctx := context.WithValue(context.TODO(), esiv1.ContextOAuth2, auth)
