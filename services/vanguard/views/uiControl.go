...
func init() {
	vanguard.AddAuthRoute("POST", "/U/setDestination", setDestination)
	vanguard.AddAuthRoute("POST", "/U/addDestination", addDestination)
	vanguard.AddAuthRoute("POST", "/U/openMarketWindow", openMarketWindow)
}
